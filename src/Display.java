...
public class Display {
    ...
    public void modifierjeu(int index, JeuxVideo jeu) {
        ...
        System.out.println("=== Modifier le Jeu ===");
        System.out.println("Modifier le nom");
        String nom = this.scan.nextLine();
        System.out.println("Modifier le studio de dévelopemment");
        String dev = this.scan.nextLine();
        System.out.println("Modifier la classification PEGI");
        int pegi = this.scan.nextInt();
        System.out.println("modifier l'année de sortie");
    ...
    public void ajouterClient() {
        System.out.print("saisissez le nom de la personne");
        String nom = this.scan.nextLine();
        System.out.print("saisisssez le prénom");
